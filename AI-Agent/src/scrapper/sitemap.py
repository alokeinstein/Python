...
"""This line calls the function but does not print the urls in the console, so other ways can be,
 you can return a print() or use use function copy method and print the copied function. """
...
4. 📌 Exception: A malicious or misconfigured site could put a <loc> tag in HTML — but it’s meaningless 
there and not standard.
"""